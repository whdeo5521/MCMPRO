	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="box box-primary">
				...
				<form role="form" name="" action="answerinsertsave.bizpoll" method="post" enctype="multipart/form-data">
				<input type="hidden" value="${bDto.bno}" id="bno" name="bno">
					<div class="box-body">
						<div class="form-group">
							<label for="title">Title</label>
							<input type="text" id="title" name="title" class="form-control" placeholder="Enter" value="RE: ${bDto.title}" readonly="readonly">
						</div>
						<div class="form-group">
							<label for="content">Content</label>
							<textarea id="content" name="content" class="form-control" rows="3" placeholder="Enter..." style="margin: 0px; width: 858px; height: 300px;">${bDto.content}</textarea>
						</div>
						<div id="file_up">
